...
COPY ledsas-sdk-direct-v${SDK_VERSION}.tar.gz .
RUN tar -xzf ledsas-sdk-direct-v${SDK_VERSION}.tar.gz && \
    pip install --no-cache-dir \
    -r requirements.txt \
    ledsas-sdk-direct-v${SDK_VERSION}/1-sdk/kbm_ledsas_sdk-${SDK_VERSION}-py3-none-any.whl && \
    rm -rf ledsas-sdk-direct-v${SDK_VERSION}.tar.gz ledsas-sdk-direct-v${SDK_VERSION}
